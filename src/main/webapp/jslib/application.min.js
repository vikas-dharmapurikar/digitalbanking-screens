...
$(window).scroll(function(e) {
    ...
    if ($w.scrollTop() == 0 || $("#left").hasClass("sidebar-fixed")) {
        $("#left .ui-resizable-handle").css("top", 0);/*height*/
    } else {
...
$(function(){
	...
	$("#toggle_nav_btn").on("click",function(){
		if(navtogglebool)
			{
			$("#toggle_nav_btn").removeClass("glyphicon glyphicon-forward").addClass("glyphicon glyphicon-backward");
			$("#fixed_navi").animate({"left":"0px"});
			$("#venterapprovalmain").animate({"margin-left":"420px"});
			navtogglebool=false;
			}

		else
			{
			$("#toggle_nav_btn").removeClass("glyphicon glyphicon-backward").addClass("glyphicon glyphicon-forward");
			$("#fixed_navi").animate({"left":"-198px"});
			$("#venterapprovalmain").animate({"margin-left":"225px"});
			navtogglebool=true;
			}
	});
	
	/* $('#apprisarcontain').slimScroll({
	        height: '250px'
	    });
	*/
});
